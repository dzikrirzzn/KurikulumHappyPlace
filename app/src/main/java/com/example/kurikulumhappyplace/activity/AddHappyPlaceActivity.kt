...
import com.example.kurikulumhappyplace.GetAddressFromLatLng
import com.example.kurikulumhappyplace.MainActivity
import com.example.kurikulumhappyplace.R
import com.example.kurikulumhappyplace.database.DatabaseHandler
...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        updateDateInView()
        dateSetListener = DatePickerDialog.OnDateSetListener { datePicker, year, bulan, tanggal ->
            ...
            if (requestCode == GALLERY) {
                if (data != null) {
                    ...
                    try {
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddHappyPlaceActivity, "Failed to Load the image from", Toast.LENGTH_SHORT
                        ).show()
                    }
                }
